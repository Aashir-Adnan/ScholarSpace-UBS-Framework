                        ...
                        apiInfo: {
                          ...
                          queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                            queryPayload: {
                              ...
                              SELECT 
                            plannedcourses.planned_course_id as plannedcourses_id, domains.domain_id as domains_id, semesters.semester_id as semesters_id, user_roles_designations_department.user_role_designation_department_id as userRolesDesignationsDepartment_id, courses.course_id as courses_id, prereqs.pre_reqs_id as prereqs_id, roles_designations_department.role_designation_department_id as rolesDesignationsDepartment_id, users.user_id as users_id, designations.designation_id as designations_id, roles.role_id as roles_id, departments.department_id as departments_id, clo.cloid as clo_id, employees.employee_id as employees_id,
                        domains.domain_id as id,
                       plannedcourses.course_name as  domains_plannedcoursesName, domains.domain_id as  domains_domainId, semesters.semester_id as  semesters_semesterId, user_roles_designations_department.user_role_designation_department_id as  userRolesDesignationsDepartment_userRoleDesignationDepartmentId, courses.course_id as  courses_courseId, prereqs.pre_reqs_id as  prereqs_preReqsId, roles_designations_department.role_designation_department_id as  rolesDesignationsDepartment_roleDesignationDepartmentId, users.username as  domains_usersName, designations.designation_name as  domains_designationsName, roles.role_name as  domains_rolesName, departments.department_name as  domains_departmentsName, clo.clodomain_name as  domains_cloName, employees.employee_id as  employees_employeeId,

                          plannedcourses.planned_course_id as domains_plannedCourseId, domains.domain_id as domains_domainId, semesters.semester_id as domains_semesterId, user_roles_designations_department.user_role_designation_department_id as domains_userRoleDesignationDepartmentId, courses.course_id as domains_courseId, prereqs.pre_reqs_id as domains_preReqsId, roles_designations_department.role_designation_department_id as domains_roleDesignationDepartmentId, users.user_id as domains_userId, designations.designation_id as domains_designationId, roles.role_id as domains_roleId, departments.department_id as domains_departmentId, clo.cloid as domains_cloid, employees.employee_id as domains_employeeId,
                          
                       
                         
                          CONCAT_WS(' ', LEFT(designations.designation_name, 10), LEFT(roles.role_name, 10), LEFT(departments.department_name, 10)) AS  domains_rolesDesignationsDepartmentName, plannedcourses.semester_id as plannedcourses_semesterId, plannedcourses.semester_id as plannedcourses_semesterId, plannedcourses.domain_id as plannedcourses_domainId, plannedcourses.domain_id as plannedcourses_domainId, plannedcourses.course_name as plannedcourses_courseName, plannedcourses.credit_hours as plannedcourses_creditHours, plannedcourses.type as plannedcourses_type, plannedcourses.required_lectures as plannedcourses_requiredLectures, plannedcourses.course_desc as plannedcourses_courseDesc, plannedcourses.course_obj as plannedcourses_courseObj, plannedcourses.image as plannedcourses_image, 
                        domains.domain_name as domains_domainName, domains.domain_leader_id as domains_domainLeaderId FROM plannedcourses LEFT JOIN domains ON domains.domain_id = plannedcourses.domain_id AND domains.status !='inactive' LEFT JOIN semesters ON semesters.semester_id = plannedcourses.semester_id AND semesters.status !='inactive' LEFT JOIN user_roles_designations_department ON () LEFT JOIN courses ON courses.planned_course_id = plannedcourses.planned_course_id AND courses.status !='inactive' LEFT JOIN prereqs ON (prereqs.planned_course_id = plannedcourses.planned_course_id OR prereqs.pre_req_course_id = plannedcourses.planned_course_id) LEFT JOIN roles_designations_department ON roles_designations_department.role_designation_department_id = user_roles_designations_department.role_designation_department_id AND roles_designations_department.status !='inactive' LEFT JOIN users ON users.user_id = user_roles_designations_department.user_id AND users.status !='inactive' LEFT JOIN designations ON designations.designation_id = roles_designations_department.designation_id AND designations.status !='inactive' LEFT JOIN roles ON roles.role_id = roles_designations_department.role_id AND roles.status !='inactive' LEFT JOIN departments ON departments.department_id = roles_designations_department.department_id AND departments.status !='inactive' LEFT JOIN clo ON clo.cloid = courses.cloid AND clo.status !='inactive' LEFT JOIN employees ON (employees.employee_id = domains.domain_leader_id OR employees.urdd_id = user_roles_designations_department.user_role_designation_department_id OR employees.employee_id = courses.teacher_employee_id OR employees.employee_id = departments.employee_id) WHERE (plannedcourses.planned_course_id = {{id}}  AND  plannedcourses.status != 'inactive')
                    ...
                    ,
                    {
                      ...
                      data: {
                       ...
                       plannedcourses.course_name as  domains_plannedcoursesName, domains.domain_id as  domains_domainId, semesters.semester_id as  semesters_semesterId, user_roles_designations_department.user_role_designation_department_id as  userRolesDesignationsDepartment_userRoleDesignationDepartmentId, courses.course_id as  courses_courseId, prereqs.pre_reqs_id as  prereqs_preReqsId, roles_designations_department.role_designation_department_id as  rolesDesignationsDepartment_roleDesignationDepartmentId, users.username as  domains_usersName, designations.designation_name as  domains_designationsName, roles.role_name as  domains_rolesName, departments.department_name as  domains_departmentsName, clo.clodomain_name as  domains_cloName, employees.employee_id as  employees_employeeId,
                          ...
                          CONCAT_WS(' ', LEFT(designations.designation_name, 10), LEFT(roles.role_name, 10), LEFT(departments.department_name, 10)) AS  domains_rolesDesignationsDepartmentName, domains.domain_name as domains_domainName, domains.domain_leader_id as domains_domainLeaderId, 
                        domains.domain_name as domains_domainName, domains.domain_leader_id as domains_domainLeaderId FROM plannedcourses LEFT JOIN domains ON domains.domain_id = plannedcourses.domain_id AND domains.status !='inactive' LEFT JOIN semesters ON semesters.semester_id = plannedcourses.semester_id AND semesters.status !='inactive' LEFT JOIN user_roles_designations_department ON () LEFT JOIN courses ON courses.planned_course_id = plannedcourses.planned_course_id AND courses.status !='inactive' LEFT JOIN prereqs ON (prereqs.planned_course_id = plannedcourses.planned_course_id OR prereqs.pre_req_course_id = plannedcourses.planned_course_id) LEFT JOIN roles_designations_department ON roles_designations_department.role_designation_department_id = user_roles_designations_department.role_designation_department_id AND roles_designations_department.status !='inactive' LEFT JOIN users ON users.user_id = user_roles_designations_department.user_id AND users.status !='inactive' LEFT JOIN designations ON designations.designation_id = roles_designations_department.designation_id AND designations.status !='inactive' LEFT JOIN roles ON roles.role_id = roles_designations_department.role_id AND roles.status !='inactive' LEFT JOIN departments ON departments.department_id = roles_designations_department.department_id AND departments.status !='inactive' LEFT JOIN clo ON clo.cloid = courses.cloid AND clo.status !='inactive' LEFT JOIN employees ON (employees.employee_id = domains.domain_leader_id OR employees.urdd_id = user_roles_designations_department.user_role_designation_department_id OR employees.employee_id = courses.teacher_employee_id OR employees.employee_id = departments.employee_id) WHERE (domains.domain_id = {{id}}  AND  domains.status != 'inactive')
                    ...
                    ,
                    {
                      ...
                      data: {
                       ...
                       plannedcourses.course_name as  domains_plannedcoursesName, domains.domain_id as  domains_domainId, semesters.semester_id as  semesters_semesterId, user_roles_designations_department.user_role_designation_department_id as  userRolesDesignationsDepartment_userRoleDesignationDepartmentId, courses.course_id as  courses_courseId, prereqs.pre_reqs_id as  prereqs_preReqsId, roles_designations_department.role_designation_department_id as  rolesDesignationsDepartment_roleDesignationDepartmentId, users.username as  domains_usersName, designations.designation_name as  domains_designationsName, roles.role_name as  domains_rolesName, departments.department_name as  domains_departmentsName, clo.clodomain_name as  domains_cloName, employees.employee_id as  employees_employeeId,
                          ...
                          CONCAT_WS(' ', LEFT(designations.designation_name, 10), LEFT(roles.role_name, 10), LEFT(departments.department_name, 10)) AS  domains_rolesDesignationsDepartmentName, semesters.program_id as semesters_programId, semesters.semester_num as semesters_semesterNum, semesters.start_date as semesters_startDate, semesters.end_date as semesters_endDate, semesters.semester_name as semesters_semesterName, 
                        domains.domain_name as domains_domainName, domains.domain_leader_id as domains_domainLeaderId FROM plannedcourses LEFT JOIN domains ON domains.domain_id = plannedcourses.domain_id AND domains.status !='inactive' LEFT JOIN semesters ON semesters.semester_id = plannedcourses.semester_id AND semesters.status !='inactive' LEFT JOIN user_roles_designations_department ON () LEFT JOIN courses ON courses.planned_course_id = plannedcourses.planned_course_id AND courses.status !='inactive' LEFT JOIN prereqs ON (prereqs.planned_course_id = plannedcourses.planned_course_id OR prereqs.pre_req_course_id = plannedcourses.planned_course_id) LEFT JOIN roles_designations_department ON roles_designations_department.role_designation_department_id = user_roles_designations_department.role_designation_department_id AND roles_designations_department.status !='inactive' LEFT JOIN users ON users.user_id = user_roles_designations_department.user_id AND users.status !='inactive' LEFT JOIN designations ON designations.designation_id = roles_designations_department.designation_id AND designations.status !='inactive' LEFT JOIN roles ON roles.role_id = roles_designations_department.role_id AND roles.status !='inactive' LEFT JOIN departments ON departments.department_id = roles_designations_department.department_id AND departments.status !='inactive' LEFT JOIN clo ON clo.cloid = courses.cloid AND clo.status !='inactive' LEFT JOIN employees ON (employees.employee_id = domains.domain_leader_id OR employees.urdd_id = user_roles_designations_department.user_role_designation_department_id OR employees.employee_id = courses.teacher_employee_id OR employees.employee_id = departments.employee_id) WHERE (semesters.semester_id = {{id}}  AND  semesters.status != 'inactive')
                    ...
                    ,
                    {
                      ...
                      data: {
                       ...
                       plannedcourses.course_name as  domains_plannedcoursesName, domains.domain_id as  domains_domainId, semesters.semester_id as  semesters_semesterId, user_roles_designations_department.user_role_designation_department_id as  userRolesDesignationsDepartment_userRoleDesignationDepartmentId, courses.course_id as  courses_courseId, prereqs.pre_reqs_id as  prereqs_preReqsId, roles_designations_department.role_designation_department_id as  rolesDesignationsDepartment_roleDesignationDepartmentId, users.username as  domains_usersName, designations.designation_name as  domains_designationsName, roles.role_name as  domains_rolesName, departments.department_name as  domains_departmentsName, clo.clodomain_name as  domains_cloName, employees.employee_id as  employees_employeeId,
                          ...
                          CONCAT_WS(' ', LEFT(designations.designation_name, 10), LEFT(roles.role_name, 10), LEFT(departments.department_name, 10)) AS  domains_rolesDesignationsDepartmentName, courses.course_sub_domain_prefix as courses_courseSubDomainPrefix, courses.planned_course_id as courses_plannedCourseId, courses.cloid as courses_cloid, courses.teacher_employee_id as courses_teacherEmployeeId, courses.tassist_employee_id as courses_tassistEmployeeId, 
                        domains.domain_name as domains_domainName, domains.domain_leader_id as domains_domainLeaderId FROM plannedcourses LEFT JOIN domains ON domains.domain_id = plannedcourses.domain_id AND domains.status !='inactive' LEFT JOIN semesters ON semesters.semester_id = plannedcourses.semester_id AND semesters.status !='inactive' LEFT JOIN user_roles_designations_department ON () LEFT JOIN courses ON courses.planned_course_id = plannedcourses.planned_course_id AND courses.status !='inactive' LEFT JOIN prereqs ON (prereqs.planned_course_id = plannedcourses.planned_course_id OR prereqs.pre_req_course_id = plannedcourses.planned_course_id) LEFT JOIN roles_designations_department ON roles_designations_department.role_designation_department_id = user_roles_designations_department.role_designation_department_id AND roles_designations_department.status !='inactive' LEFT JOIN users ON users.user_id = user_roles_designations_department.user_id AND users.status !='inactive' LEFT JOIN designations ON designations.designation_id = roles_designations_department.designation_id AND designations.status !='inactive' LEFT JOIN roles ON roles.role_id = roles_designations_department.role_id AND roles.status !='inactive' LEFT JOIN departments ON departments.department_id = roles_designations_department.department_id AND departments.status !='inactive' LEFT JOIN clo ON clo.cloid = courses.cloid AND clo.status !='inactive' LEFT JOIN employees ON (employees.employee_id = domains.domain_leader_id OR employees.urdd_id = user_roles_designations_department.user_role_designation_department_id OR employees.employee_id = courses.teacher_employee_id OR employees.employee_id = departments.employee_id) WHERE (courses.course_id = {{id}}  AND  courses.status != 'inactive')
                    ...
                    ,
                    {
                      ...
                      data: {
                       ...
                       plannedcourses.course_name as  domains_plannedcoursesName, domains.domain_id as  domains_domainId, semesters.semester_id as  semesters_semesterId, user_roles_designations_department.user_role_designation_department_id as  userRolesDesignationsDepartment_userRoleDesignationDepartmentId, courses.course_id as  courses_courseId, prereqs.pre_reqs_id as  prereqs_preReqsId, roles_designations_department.role_designation_department_id as  rolesDesignationsDepartment_roleDesignationDepartmentId, users.username as  domains_usersName, designations.designation_name as  domains_designationsName, roles.role_name as  domains_rolesName, departments.department_name as  domains_departmentsName, clo.clodomain_name as  domains_cloName, employees.employee_id as  employees_employeeId,
                          ...
                          CONCAT_WS(' ', LEFT(designations.designation_name, 10), LEFT(roles.role_name, 10), LEFT(departments.department_name, 10)) AS  domains_rolesDesignationsDepartmentName, prereqs.planned_course_id as prereqs_plannedCourseId, prereqs.pre_req_course_id as prereqs_preReqCourseId, 
                        domains.domain_name as domains_domainName, domains.domain_leader_id as domains_domainLeaderId FROM plannedcourses LEFT JOIN domains ON domains.domain_id = plannedcourses.domain_id AND domains.status !='inactive' LEFT JOIN semesters ON semesters.semester_id = plannedcourses.semester_id AND semesters.status !='inactive' LEFT JOIN user_roles_designations_department ON () LEFT JOIN courses ON courses.planned_course_id = plannedcourses.planned_course_id AND courses.status !='inactive' LEFT JOIN prereqs ON (prereqs.planned_course_id = plannedcourses.planned_course_id OR prereqs.pre_req_course_id = plannedcourses.planned_course_id) LEFT JOIN roles_designations_department ON roles_designations_department.role_designation_department_id = user_roles_designations_department.role_designation_department_id AND roles_designations_department.status !='inactive' LEFT JOIN users ON users.user_id = user_roles_designations_department.user_id AND users.status !='inactive' LEFT JOIN designations ON designations.designation_id = roles_designations_department.designation_id AND designations.status !='inactive' LEFT JOIN roles ON roles.role_id = roles_designations_department.role_id AND roles.status !='inactive' LEFT JOIN departments ON departments.department_id = roles_designations_department.department_id AND departments.status !='inactive' LEFT JOIN clo ON clo.cloid = courses.cloid AND clo.status !='inactive' LEFT JOIN employees ON (employees.employee_id = domains.domain_leader_id OR employees.urdd_id = user_roles_designations_department.user_role_designation_department_id OR employees.employee_id = courses.teacher_employee_id OR employees.employee_id = departments.employee_id) WHERE (prereqs.pre_reqs_id = {{id}}  AND  prereqs.status != 'inactive')
