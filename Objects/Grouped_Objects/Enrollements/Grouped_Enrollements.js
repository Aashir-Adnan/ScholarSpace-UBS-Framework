                        ...
                        apiInfo: {
                          ...
                          queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                            queryPayload: {
                              ...
                              SELECT 
                            enrollements.enrollement_id as enrollements_id, courses.course_id as courses_id, feedbacks.feedback_id as feedbacks_id, lecturesattendance.attendance_id as lecturesattendance_id, subcomponentmarks.sub_component_mark_id as subcomponentmarks_id, plannedcourses.planned_course_id as plannedcourses_id, clo.cloid as clo_id, employees.employee_id as employees_id, user_roles_designations_department.user_role_designation_department_id as userRolesDesignationsDepartment_id, roles_designations_department.role_designation_department_id as rolesDesignationsDepartment_id, users.user_id as users_id, designations.designation_id as designations_id, roles.role_id as roles_id, departments.department_id as departments_id, feedbackquestions.questions_id as feedbackquestions_id, subcomponents.sub_component_id as subcomponents_id,
                        courses.course_id as id,
                       enrollements.group_name as  courses_enrollementsName, courses.course_id as  courses_courseId, feedbacks.feedback_id as  feedbacks_feedbackId, lecturesattendance.attendance_id as  lecturesattendance_attendanceId, subcomponentmarks.sub_component_mark_id as  subcomponentmarks_subComponentMarkId, plannedcourses.course_name as  courses_plannedcoursesName, clo.clodomain_name as  courses_cloName, employees.employee_id as  employees_employeeId, user_roles_designations_department.user_role_designation_department_id as  userRolesDesignationsDepartment_userRoleDesignationDepartmentId, roles_designations_department.role_designation_department_id as  rolesDesignationsDepartment_roleDesignationDepartmentId, users.username as  courses_usersName, designations.designation_name as  courses_designationsName, roles.role_name as  courses_rolesName, departments.department_name as  courses_departmentsName, feedbackquestions.questions_id as  feedbackquestions_questionsId, subcomponents.sub_component_id as  subcomponents_subComponentId,

                          enrollements.enrollement_id as courses_enrollementId, courses.course_id as courses_courseId, feedbacks.feedback_id as courses_feedbackId, lecturesattendance.attendance_id as courses_attendanceId, subcomponentmarks.sub_component_mark_id as courses_subComponentMarkId, plannedcourses.planned_course_id as courses_plannedCourseId, clo.cloid as courses_cloid, employees.employee_id as courses_employeeId, user_roles_designations_department.user_role_designation_department_id as courses_userRoleDesignationDepartmentId, roles_designations_department.role_designation_department_id as courses_roleDesignationDepartmentId, users.user_id as courses_userId, designations.designation_id as courses_designationId, roles.role_id as courses_roleId, departments.department_id as courses_departmentId, feedbackquestions.questions_id as courses_questionsId, subcomponents.sub_component_id as courses_subComponentId,
                    ...
                    ,
                    {
                      ...
                      data: {
                       ...
                       enrollements.group_name as  courses_enrollementsName, courses.course_id as  courses_courseId, feedbacks.feedback_id as  feedbacks_feedbackId, lecturesattendance.attendance_id as  lecturesattendance_attendanceId, subcomponentmarks.sub_component_mark_id as  subcomponentmarks_subComponentMarkId, plannedcourses.course_name as  courses_plannedcoursesName, clo.clodomain_name as  courses_cloName, employees.employee_id as  employees_employeeId, user_roles_designations_department.user_role_designation_department_id as  userRolesDesignationsDepartment_userRoleDesignationDepartmentId, roles_designations_department.role_designation_department_id as  rolesDesignationsDepartment_roleDesignationDepartmentId, users.username as  courses_usersName, designations.designation_name as  courses_designationsName, roles.role_name as  courses_rolesName, departments.department_name as  courses_departmentsName, feedbackquestions.questions_id as  feedbackquestions_questionsId, subcomponents.sub_component_id as  subcomponents_subComponentId,
                        ...
                        courses.course_sub_domain_prefix as courses_courseSubDomainPrefix, courses.planned_course_id as courses_plannedCourseId, courses.cloid as courses_cloid, courses.teacher_employee_id as courses_teacherEmployeeId, courses.tassist_employee_id as courses_tassistEmployeeId FROM enrollements LEFT JOIN courses ON courses.course_id = enrollements.course_id AND courses.status !='inactive' LEFT JOIN feedbacks ON feedbacks.enrollement_id = enrollements.enrollement_id AND feedbacks.status !='inactive' LEFT JOIN lecturesattendance ON lecturesattendance.enrollement_id = enrollements.enrollement_id AND lecturesattendance.status !='inactive' LEFT JOIN subcomponentmarks ON subcomponentmarks.enrollment_id = enrollements.enrollement_id AND subcomponentmarks.status !='inactive' LEFT JOIN plannedcourses ON plannedcourses.planned_course_id = courses.planned_course_id AND plannedcourses.status !='inactive' LEFT JOIN clo ON clo.cloid = courses.cloid AND clo.status !='inactive' LEFT JOIN employees ON employees.employee_id = courses.teacher_employee_id AND employees.status !='inactive' LEFT JOIN user_roles_designations_department ON user_roles_designations_department.user_role_designation_department_id = employees.urdd_id AND user_roles_designations_department.status !='inactive' LEFT JOIN roles_designations_department ON roles_designations_department.role_designation_department_id = user_roles_designations_department.role_designation_department_id AND roles_designations_department.status !='inactive' LEFT JOIN users ON users.user_id = user_roles_designations_department.user_id AND users.status !='inactive' LEFT JOIN designations ON designations.designation_id = roles_designations_department.designation_id AND designations.status !='inactive' LEFT JOIN roles ON roles.role_id = roles_designations_department.role_id AND roles.status !='inactive' LEFT JOIN departments ON (departments.employee_id = employees.employee_id OR departments.department_id = roles_designations_department.department_id) LEFT JOIN feedbackquestions ON feedbackquestions.questions_id = feedbacks.feedback_question_id AND feedbackquestions.status !='inactive' LEFT JOIN subcomponents ON (subcomponents.sub_component_id = lecturesattendance.sub_component_id OR subcomponents.sub_component_id = subcomponentmarks.sub_component_id) WHERE (courses.course_id = {{id}}  AND  courses.status != 'inactive')
                    ...
                    ,
                    {
                      ...
                      data: {
                       ...
                       enrollements.group_name as  courses_enrollementsName, courses.course_id as  courses_courseId, feedbacks.feedback_id as  feedbacks_feedbackId, lecturesattendance.attendance_id as  lecturesattendance_attendanceId, subcomponentmarks.sub_component_mark_id as  subcomponentmarks_subComponentMarkId, plannedcourses.course_name as  courses_plannedcoursesName, clo.clodomain_name as  courses_cloName, employees.employee_id as  employees_employeeId, user_roles_designations_department.user_role_designation_department_id as  userRolesDesignationsDepartment_userRoleDesignationDepartmentId, roles_designations_department.role_designation_department_id as  rolesDesignationsDepartment_roleDesignationDepartmentId, users.username as  courses_usersName, designations.designation_name as  courses_designationsName, roles.role_name as  courses_rolesName, departments.department_name as  courses_departmentsName, feedbackquestions.questions_id as  feedbackquestions_questionsId, subcomponents.sub_component_id as  subcomponents_subComponentId,
                        ...
                        courses.course_sub_domain_prefix as courses_courseSubDomainPrefix, courses.planned_course_id as courses_plannedCourseId, courses.cloid as courses_cloid, courses.teacher_employee_id as courses_teacherEmployeeId, courses.tassist_employee_id as courses_tassistEmployeeId FROM enrollements LEFT JOIN courses ON courses.course_id = enrollements.course_id AND courses.status !='inactive' LEFT JOIN feedbacks ON feedbacks.enrollement_id = enrollements.enrollement_id AND feedbacks.status !='inactive' LEFT JOIN lecturesattendance ON lecturesattendance.enrollement_id = enrollements.enrollement_id AND lecturesattendance.status !='inactive' LEFT JOIN subcomponentmarks ON subcomponentmarks.enrollment_id = enrollements.enrollement_id AND subcomponentmarks.status !='inactive' LEFT JOIN plannedcourses ON plannedcourses.planned_course_id = courses.planned_course_id AND plannedcourses.status !='inactive' LEFT JOIN clo ON clo.cloid = courses.cloid AND clo.status !='inactive' LEFT JOIN employees ON employees.employee_id = courses.teacher_employee_id AND employees.status !='inactive' LEFT JOIN user_roles_designations_department ON user_roles_designations_department.user_role_designation_department_id = employees.urdd_id AND user_roles_designations_department.status !='inactive' LEFT JOIN roles_designations_department ON roles_designations_department.role_designation_department_id = user_roles_designations_department.role_designation_department_id AND roles_designations_department.status !='inactive' LEFT JOIN users ON users.user_id = user_roles_designations_department.user_id AND users.status !='inactive' LEFT JOIN designations ON designations.designation_id = roles_designations_department.designation_id AND designations.status !='inactive' LEFT JOIN roles ON roles.role_id = roles_designations_department.role_id AND roles.status !='inactive' LEFT JOIN departments ON (departments.employee_id = employees.employee_id OR departments.department_id = roles_designations_department.department_id) LEFT JOIN feedbackquestions ON feedbackquestions.questions_id = feedbacks.feedback_question_id AND feedbackquestions.status !='inactive' LEFT JOIN subcomponents ON (subcomponents.sub_component_id = lecturesattendance.sub_component_id OR subcomponents.sub_component_id = subcomponentmarks.sub_component_id) WHERE (feedbacks.feedback_id = {{id}}  AND  feedbacks.status != 'inactive')
                    ...
                    ,
                    {
                      ...
                      data: {
                       ...
                       enrollements.group_name as  courses_enrollementsName, courses.course_id as  courses_courseId, feedbacks.feedback_id as  feedbacks_feedbackId, lecturesattendance.attendance_id as  lecturesattendance_attendanceId, subcomponentmarks.sub_component_mark_id as  subcomponentmarks_subComponentMarkId, plannedcourses.course_name as  courses_plannedcoursesName, clo.clodomain_name as  courses_cloName, employees.employee_id as  employees_employeeId, user_roles_designations_department.user_role_designation_department_id as  userRolesDesignationsDepartment_userRoleDesignationDepartmentId, roles_designations_department.role_designation_department_id as  rolesDesignationsDepartment_roleDesignationDepartmentId, users.username as  courses_usersName, designations.designation_name as  courses_designationsName, roles.role_name as  courses_rolesName, departments.department_name as  courses_departmentsName, feedbackquestions.questions_id as  feedbackquestions_questionsId, subcomponents.sub_component_id as  subcomponents_subComponentId,
                        ...
                        courses.course_sub_domain_prefix as courses_courseSubDomainPrefix, courses.planned_course_id as courses_plannedCourseId, courses.cloid as courses_cloid, courses.teacher_employee_id as courses_teacherEmployeeId, courses.tassist_employee_id as courses_tassistEmployeeId FROM enrollements LEFT JOIN courses ON courses.course_id = enrollements.course_id AND courses.status !='inactive' LEFT JOIN feedbacks ON feedbacks.enrollement_id = enrollements.enrollement_id AND feedbacks.status !='inactive' LEFT JOIN lecturesattendance ON lecturesattendance.enrollement_id = enrollements.enrollement_id AND lecturesattendance.status !='inactive' LEFT JOIN subcomponentmarks ON subcomponentmarks.enrollment_id = enrollements.enrollement_id AND subcomponentmarks.status !='inactive' LEFT JOIN plannedcourses ON plannedcourses.planned_course_id = courses.planned_course_id AND plannedcourses.status !='inactive' LEFT JOIN clo ON clo.cloid = courses.cloid AND clo.status !='inactive' LEFT JOIN employees ON employees.employee_id = courses.teacher_employee_id AND employees.status !='inactive' LEFT JOIN user_roles_designations_department ON user_roles_designations_department.user_role_designation_department_id = employees.urdd_id AND user_roles_designations_department.status !='inactive' LEFT JOIN roles_designations_department ON roles_designations_department.role_designation_department_id = user_roles_designations_department.role_designation_department_id AND roles_designations_department.status !='inactive' LEFT JOIN users ON users.user_id = user_roles_designations_department.user_id AND users.status !='inactive' LEFT JOIN designations ON designations.designation_id = roles_designations_department.designation_id AND designations.status !='inactive' LEFT JOIN roles ON roles.role_id = roles_designations_department.role_id AND roles.status !='inactive' LEFT JOIN departments ON (departments.employee_id = employees.employee_id OR departments.department_id = roles_designations_department.department_id) LEFT JOIN feedbackquestions ON feedbackquestions.questions_id = feedbacks.feedback_question_id AND feedbackquestions.status !='inactive' LEFT JOIN subcomponents ON (subcomponents.sub_component_id = lecturesattendance.sub_component_id OR subcomponents.sub_component_id = subcomponentmarks.sub_component_id) WHERE (subcomponentmarks.sub_component_mark_id = {{id}}  AND  subcomponentmarks.status != 'inactive')
