                        ...
                        apiInfo: {
                          ...
                          queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                            queryPayload: {
                              ...
                              Update: async(req, decryptedPayload) => { return "UPDATE chat SET sub_component_id = {{chat_subComponentId}}, user_role_id = {{chat_userRoleId}}, message = {{chat_message}}, message_time = {{chat_messageTime}}, private_chat = {{chat_privateChat}}, created_by = {{chat_createdBy}}, updated_by = {{chat_updatedBy}} WHERE chat_id = {{id}}"},
