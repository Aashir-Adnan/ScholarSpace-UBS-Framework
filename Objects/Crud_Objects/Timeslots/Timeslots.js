                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, timeslots.time_slot_id as timeslots_id, timeslots.time_slot_id as id, timeslots.time_slot_id as timeslots_timeSlotId,timeslots.start_time as timeslots_startTime,timeslots.end_time as timeslots_endTime,timeslots.day as timeslots_day FROM timeslots  Where timeslots.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT timeslots.time_slot_id as timeslots_id, timeslots.time_slot_id as id, timeslots.time_slot_id as timeslots_timeSlotId,timeslots.start_time as timeslots_startTime,timeslots.end_time as timeslots_endTime,timeslots.day as timeslots_day FROM timeslots  WHERE time_slot_id = {{id}} OR time_slot_id IS NULL"},
