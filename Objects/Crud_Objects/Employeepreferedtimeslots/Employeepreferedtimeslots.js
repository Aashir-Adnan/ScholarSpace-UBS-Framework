                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, employeepreferedtimeslots.employee_prefered_time_slots_id as employeepreferedtimeslots_id, employeepreferedtimeslots.employee_prefered_time_slots_id as id, employeepreferedtimeslots.employee_prefered_time_slots_id as employeepreferedtimeslots_employeePreferedTimeSlotsId,employeepreferedtimeslots.employee_id as employeepreferedtimeslots_employeeId,employeepreferedtimeslots.time_slot_id as employeepreferedtimeslots_timeSlotId FROM employeepreferedtimeslots  Where employeepreferedtimeslots.status != 'inactive' "},
