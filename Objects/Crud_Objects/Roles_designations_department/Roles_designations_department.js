                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            Update: async(req, decryptedPayload) => { return "UPDATE roles_designations_department SET designation_id = {{rolesDesignationsDepartment_designationId}}, designation_id = {{rolesDesignationsDepartment_designationId}}, role_id = {{rolesDesignationsDepartment_roleId}}, role_id = {{rolesDesignationsDepartment_roleId}}, department_id = {{rolesDesignationsDepartment_departmentId}}, department_id = {{rolesDesignationsDepartment_departmentId}} WHERE role_designation_department_id = {{id}}"},
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, roles_designations_department.role_designation_department_id as rolesDesignationsDepartment_id, roles_designations_department.role_designation_department_id as id, roles_designations_department.role_designation_department_id as rolesDesignationsDepartment_roleDesignationDepartmentId,roles_designations_department.designation_id as rolesDesignationsDepartment_designationId,roles_designations_department.designation_id as rolesDesignationsDepartment_designationId,roles_designations_department.role_id as rolesDesignationsDepartment_roleId,roles_designations_department.role_id as rolesDesignationsDepartment_roleId,roles_designations_department.department_id as rolesDesignationsDepartment_departmentId,roles_designations_department.department_id as rolesDesignationsDepartment_departmentId,roles_designations_department.created_by as rolesDesignationsDepartment_createdBy,roles_designations_department.updated_by as rolesDesignationsDepartment_updatedBy,roles_designations_department.status as rolesDesignationsDepartment_status,roles_designations_department.created_at as rolesDesignationsDepartment_createdAt,roles_designations_department.updated_at as rolesDesignationsDepartment_updatedAt, designations.designation_name as designations_designationName,roles.role_name as roles_roleName,departments.department_name as departments_departmentName FROM roles_designations_department LEFT JOIN designations ON roles_designations_department.designation_id = designations.designation_id LEFT JOIN roles ON roles_designations_department.role_id = roles.role_id LEFT JOIN departments ON roles_designations_department.department_id = departments.department_id Where roles_designations_department.status != 'inactive' "},
