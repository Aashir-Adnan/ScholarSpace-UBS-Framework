                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, platforms.platform_id as platforms_id, platforms.platform_id as id, platforms.platform_id as platforms_platformId,platforms.platform_name as platforms_platformName,platforms.status as platforms_status,platforms.created_by as platforms_createdBy,platforms.updated_by as platforms_updatedBy,platforms.created_at as platforms_createdAt,platforms.updated_at as platforms_updatedAt FROM platforms  Where platforms.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT platforms.platform_id as platforms_id, platforms.platform_id as id, platforms.platform_id as platforms_platformId,platforms.platform_name as platforms_platformName,platforms.status as platforms_status,platforms.created_by as platforms_createdBy,platforms.updated_by as platforms_updatedBy,platforms.created_at as platforms_createdAt,platforms.updated_at as platforms_updatedAt FROM platforms  WHERE platform_id = {{id}} OR platform_id IS NULL"},
