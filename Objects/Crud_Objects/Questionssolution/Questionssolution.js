                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, questionssolution.questions_help_guide_id as questionssolution_id, questionssolution.questions_help_guide_id as id, questionssolution.questions_help_guide_id as questionssolution_questionsHelpGuideId,questionssolution.question_id as questionssolution_questionId,questionssolution.attachment_id as questionssolution_attachmentId FROM questionssolution  Where questionssolution.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT questionssolution.questions_help_guide_id as questionssolution_id, questionssolution.questions_help_guide_id as id, questionssolution.questions_help_guide_id as questionssolution_questionsHelpGuideId,questionssolution.question_id as questionssolution_questionId,questionssolution.attachment_id as questionssolution_attachmentId FROM questionssolution  WHERE questions_help_guide_id = {{id}} OR questions_help_guide_id IS NULL"},
