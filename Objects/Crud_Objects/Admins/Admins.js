                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, admins.admin_id as admins_id, admins.admin_id as id, admins.admin_id as admins_adminId,admins.admin_type as admins_adminType,admins.user_role_id as admins_userRoleId FROM admins  Where admins.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT admins.admin_id as admins_id, admins.admin_id as id, admins.admin_id as admins_adminId,admins.admin_type as admins_adminType,admins.user_role_id as admins_userRoleId FROM admins  WHERE admin_id = {{id}} OR admin_id IS NULL"},
