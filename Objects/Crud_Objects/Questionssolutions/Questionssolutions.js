                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, questionssolutions.questions_help_guide_id as questionssolutions_id, questionssolutions.questions_help_guide_id as id, questionssolutions.questions_help_guide_id as questionssolutions_questionsHelpGuideId FROM questionssolutions  Where questionssolutions.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT questionssolutions.questions_help_guide_id as questionssolutions_id, questionssolutions.questions_help_guide_id as id, questionssolutions.questions_help_guide_id as questionssolutions_questionsHelpGuideId FROM questionssolutions  WHERE questions_help_guide_id = {{id}} OR questions_help_guide_id IS NULL"},
