                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, plo.ploid as plo_id, plo.ploid as id, plo.ploid as plo_ploid,plo.program_id as plo_programId,plo.ploname as plo_ploname,plo.plonum as plo_plonum, programs.program_name as programs_programName FROM plo LEFT JOIN programs ON plo.program_id = programs.program_id Where plo.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT plo.ploid as plo_id, plo.ploid as id, plo.ploid as plo_ploid,plo.program_id as plo_programId,plo.ploname as plo_ploname,plo.plonum as plo_plonum, programs.program_name as programs_programName FROM plo LEFT JOIN programs ON plo.program_id = programs.program_id WHERE ploid = {{id}} OR ploid IS NULL"},
