                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, subcomponentmarks.sub_component_mark_id as subcomponentmarks_id, subcomponentmarks.sub_component_mark_id as id, subcomponentmarks.sub_component_mark_id as subcomponentmarks_subComponentMarkId,subcomponentmarks.sub_component_id as subcomponentmarks_subComponentId,subcomponentmarks.enrollment_id as subcomponentmarks_enrollmentId,subcomponentmarks.obtained_marks as subcomponentmarks_obtainedMarks,subcomponentmarks.out_of_marks as subcomponentmarks_outOfMarks, enrollements.group_name as enrollements_groupName FROM subcomponentmarks LEFT JOIN enrollements ON subcomponentmarks.enrollment_id = enrollements.enrollement_id Where subcomponentmarks.status != 'inactive' "},
