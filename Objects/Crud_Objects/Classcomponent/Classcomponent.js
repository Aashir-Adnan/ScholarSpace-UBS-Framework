                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, classcomponent.component_id as classcomponent_id, classcomponent.component_id as id, classcomponent.component_id as classcomponent_componentId,classcomponent.course_id as classcomponent_courseId,classcomponent.component_type as classcomponent_componentType,classcomponent.component_name as classcomponent_componentName,classcomponent.weightage as classcomponent_weightage,classcomponent.component_policy as classcomponent_componentPolicy FROM classcomponent  Where classcomponent.status != 'inactive' "},
