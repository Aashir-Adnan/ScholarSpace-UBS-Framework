                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, roles.role_id as roles_id, roles.role_id as id, roles.role_id as roles_roleId,roles.role_name as roles_roleName FROM roles  Where roles.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT roles.role_id as roles_id, roles.role_id as id, roles.role_id as roles_roleId,roles.role_name as roles_roleName FROM roles  WHERE role_id = {{id}} OR role_id IS NULL"},
