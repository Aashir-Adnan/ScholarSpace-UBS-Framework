                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, books.book_id as books_id, books.book_id as id, books.book_id as books_bookId,books.course_id as books_courseId,books.book_ibn as books_bookIbn,books.book_name as books_bookName FROM books  Where books.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT books.book_id as books_id, books.book_id as id, books.book_id as books_bookId,books.course_id as books_courseId,books.book_ibn as books_bookIbn,books.book_name as books_bookName FROM books  WHERE book_id = {{id}} OR book_id IS NULL"},
