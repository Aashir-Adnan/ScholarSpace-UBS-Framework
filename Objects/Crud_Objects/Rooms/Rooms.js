                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, rooms.room_id as rooms_id, rooms.room_id as id, rooms.room_id as rooms_roomId,rooms.room_name as rooms_roomName,rooms.room_capacity as rooms_roomCapacity,rooms.room_location as rooms_roomLocation FROM rooms  Where rooms.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT rooms.room_id as rooms_id, rooms.room_id as id, rooms.room_id as rooms_roomId,rooms.room_name as rooms_roomName,rooms.room_capacity as rooms_roomCapacity,rooms.room_location as rooms_roomLocation FROM rooms  WHERE room_id = {{id}} OR room_id IS NULL"},
