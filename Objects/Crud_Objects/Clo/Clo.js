                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, clo.cloid as clo_id, clo.cloid as id, clo.cloid as clo_cloid,clo.clonum as clo_clonum,clo.clodomain_name as clo_clodomainName,clo.description as clo_description FROM clo  Where clo.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT clo.cloid as clo_id, clo.cloid as id, clo.cloid as clo_cloid,clo.clonum as clo_clonum,clo.clodomain_name as clo_clodomainName,clo.description as clo_description FROM clo  WHERE cloid = {{id}} OR cloid IS NULL"},
