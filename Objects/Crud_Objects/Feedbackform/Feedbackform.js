                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, feedbackform.feed_back_form_id as feedbackform_id, feedbackform.feed_back_form_id as id, feedbackform.feed_back_form_id as feedbackform_feedBackFormId,feedbackform.feed_back_form_id as feedbackform_feedBackFormId,feedbackform.form_name as feedbackform_formName,feedbackform.start_date as feedbackform_startDate,feedbackform.end_date as feedbackform_endDate,feedbackform.status as feedbackform_status,feedbackform.created_by as feedbackform_createdBy,feedbackform.updated_by as feedbackform_updatedBy,feedbackform.created_at as feedbackform_createdAt,feedbackform.updated_at as feedbackform_updatedAt FROM feedbackform  Where feedbackform.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT feedbackform.feed_back_form_id as feedbackform_id, feedbackform.feed_back_form_id as id, feedbackform.feed_back_form_id as feedbackform_feedBackFormId,feedbackform.feed_back_form_id as feedbackform_feedBackFormId,feedbackform.form_name as feedbackform_formName,feedbackform.start_date as feedbackform_startDate,feedbackform.end_date as feedbackform_endDate,feedbackform.status as feedbackform_status,feedbackform.created_by as feedbackform_createdBy,feedbackform.updated_by as feedbackform_updatedBy,feedbackform.created_at as feedbackform_createdAt,feedbackform.updated_at as feedbackform_updatedAt FROM feedbackform  WHERE feed_back_form_id = {{id}} OR feed_back_form_id IS NULL"},
