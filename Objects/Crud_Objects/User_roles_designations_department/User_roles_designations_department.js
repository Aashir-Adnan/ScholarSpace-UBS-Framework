                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, user_roles_designations_department.user_role_designation_department_id as userRolesDesignationsDepartment_id, user_roles_designations_department.user_role_designation_department_id as id, user_roles_designations_department.user_role_designation_department_id as userRolesDesignationsDepartment_userRoleDesignationDepartmentId,user_roles_designations_department.role_designation_department_id as userRolesDesignationsDepartment_roleDesignationDepartmentId,user_roles_designations_department.user_id as userRolesDesignationsDepartment_userId,user_roles_designations_department.spec_attributes as userRolesDesignationsDepartment_specAttributes,user_roles_designations_department.start_date as userRolesDesignationsDepartment_startDate,user_roles_designations_department.end_date as userRolesDesignationsDepartment_endDate,user_roles_designations_department.status as userRolesDesignationsDepartment_status,user_roles_designations_department.created_by as userRolesDesignationsDepartment_createdBy,user_roles_designations_department.updated_by as userRolesDesignationsDepartment_updatedBy,user_roles_designations_department.created_at as userRolesDesignationsDepartment_createdAt,user_roles_designations_department.updated_at as userRolesDesignationsDepartment_updatedAt, users.username as users_username FROM user_roles_designations_department LEFT JOIN users ON user_roles_designations_department.user_id = users.user_id Where user_roles_designations_department.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT user_roles_designations_department.user_role_designation_department_id as userRolesDesignationsDepartment_id, user_roles_designations_department.user_role_designation_department_id as id, user_roles_designations_department.user_role_designation_department_id as userRolesDesignationsDepartment_userRoleDesignationDepartmentId,user_roles_designations_department.role_designation_department_id as userRolesDesignationsDepartment_roleDesignationDepartmentId,user_roles_designations_department.user_id as userRolesDesignationsDepartment_userId,user_roles_designations_department.spec_attributes as userRolesDesignationsDepartment_specAttributes,user_roles_designations_department.start_date as userRolesDesignationsDepartment_startDate,user_roles_designations_department.end_date as userRolesDesignationsDepartment_endDate,user_roles_designations_department.status as userRolesDesignationsDepartment_status,user_roles_designations_department.created_by as userRolesDesignationsDepartment_createdBy,user_roles_designations_department.updated_by as userRolesDesignationsDepartment_updatedBy,user_roles_designations_department.created_at as userRolesDesignationsDepartment_createdAt,user_roles_designations_department.updated_at as userRolesDesignationsDepartment_updatedAt, users.username as users_username FROM user_roles_designations_department LEFT JOIN users ON user_roles_designations_department.user_id = users.user_id WHERE user_role_designation_department_id = {{id}} OR user_role_designation_department_id IS NULL"},
