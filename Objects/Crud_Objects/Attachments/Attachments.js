                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, attachments.attachment_id as attachments_id, attachments.attachment_id as id, attachments.attachment_id as attachments_attachmentId,attachments.attachment_name as attachments_attachmentName,attachments.attachment_type as attachments_attachmentType,attachments.attachment_size as attachments_attachmentSize,attachments.attachment_link as attachments_attachmentLink,attachments.status as attachments_status,attachments.created_by as attachments_createdBy,attachments.updated_by as attachments_updatedBy,attachments.created_at as attachments_createdAt,attachments.updated_at as attachments_updatedAt FROM attachments  Where attachments.status != 'inactive' "},
                            View: async(req, decryptedPayload) => { return "SELECT attachments.attachment_id as attachments_id, attachments.attachment_id as id, attachments.attachment_id as attachments_attachmentId,attachments.attachment_name as attachments_attachmentName,attachments.attachment_type as attachments_attachmentType,attachments.attachment_size as attachments_attachmentSize,attachments.attachment_link as attachments_attachmentLink,attachments.status as attachments_status,attachments.created_by as attachments_createdBy,attachments.updated_by as attachments_updatedBy,attachments.created_at as attachments_createdAt,attachments.updated_at as attachments_updatedAt FROM attachments  WHERE attachment_id = {{id}} OR attachment_id IS NULL"},
